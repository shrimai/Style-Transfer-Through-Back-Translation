...
# Translte the democratic data from English to French
...
python translate.py -model ../models/democratic_generator.pt -src ../data/political_data/republican_only.test.fr -output trained_models/republican_democratic.txt -replace_unk $true
